...
func (message *Format12) GetHorizontalProtectionLimit() fields.HPLAirborne {
	return fields.HPLABetween185Dot2MAnd370Dot4M
}

// GetContainmentRadius returns the ContainmentRadius
func (message *Format12) GetContainmentRadius() fields.ContainmentRadiusAirborne {
	return fields.CRABetween92Dot6MAnd185Dot2M
}
