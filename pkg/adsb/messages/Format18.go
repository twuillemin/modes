...
func (message *Format18) GetCPRFormat() fields.CPRFormat {
...
func (message *Format18) GetHorizontalProtectionLimit() fields.HPLAirborne {
	return fields.HPLALargerThan37Point04Km
}

// GetContainmentRadius returns the ContainmentRadius
func (message *Format18) GetContainmentRadius() fields.ContainmentRadiusAirborne {
	return fields.CRALargerThan18Point52
}
