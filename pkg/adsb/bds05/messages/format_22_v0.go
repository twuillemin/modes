...
//
// This file was generated by gen_formats_v0.go at 2024-06-02 22:43:42.1398863 +0300 EEST m=+0.006879101
package messages
...
func (message Format22V0) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format22V0) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format22V0) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}
...
// ReadFormat22V0 reads a message at the format Format22V0
