...
//
// This file was generated by gen_formats_v0.go at 2024-06-02 01:03:27.3745282 +0300 EEST m=+0.005834801
package messages
...
func (message Format18V0) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format18V0) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format18V0) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}
...
// ReadFormat18V0 reads a message at the format Format18V0
