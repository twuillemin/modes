...
//
// This file was generated by gen_formats_v1.go at 2024-06-02 01:03:28.0006292 +0300 EEST m=+0.005437501
package messages
...
func (message Format17V1) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format17V1) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel1
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format17V1) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel1
}
