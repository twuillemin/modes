...
//
// This file was generated by gen_formats_v0.go at 2024-06-02 01:03:27.3750474 +0300 EEST m=+0.006354001
package messages
...
// Format20V0 is a message at the format BDS 0,5 for ADSB V0
type Format20V0 struct {
...
func (message Format20V0) GetMessageFormat() adsb.MessageFormat {
	return adsb.Format20
}

// GetRegister returns the register of the message
func (message Format20V0) GetRegister() bds.Register {
	return adsb.Format20.GetRegister()
}

// GetSubtype returns the subtype of the message if any
func (message Format20V0) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format20V0) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format20V0) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel0
}

// GetSurveillanceStatus returns the Surveillance Status
func (message Format20V0) GetSurveillanceStatus() fields.SurveillanceStatus {
	return message.SurveillanceStatus
}

// GetSingleAntennaFlag returns the SingleAntennaFlag
func (message Format20V0) GetSingleAntennaFlag() fields.SingleAntennaFlag {
	return message.SingleAntennaFlag
}

// GetAltitude returns the Altitude
func (message Format20V0) GetAltitude() fields.Altitude {
	return message.Altitude
}

// GetTime returns the Time
func (message Format20V0) GetTime() fields.Time {
	return message.Time
}

// GetCPRFormat returns the CompactPositionReportingFormat
func (message Format20V0) GetCPRFormat() fields.CompactPositionReportingFormat {
	return message.CPRFormat
}

// GetEncodedLatitude returns the EncodedLatitude
func (message Format20V0) GetEncodedLatitude() fields.EncodedLatitude {
	return message.EncodedLatitude
}

// GetEncodedLongitude returns the EncodedLongitude
func (message Format20V0) GetEncodedLongitude() fields.EncodedLongitude {
	return message.EncodedLongitude
}

// GetHorizontalProtectionLimit returns the HorizontalProtectionLimit
func (message Format20V0) GetHorizontalProtectionLimit() fields.HorizontalProtectionLimit {
	return message.HorizontalProtectionLimit
}

// GetContainmentRadius returns the ContainmentRadius
func (message Format20V0) GetContainmentRadius() fields.ContainmentRadius {
	return message.ContainmentRadius
}

// ToString returns a basic, but readable, representation of the message
func (message Format20V0) ToString() string {
	return bds05v0ToString(message)
}

// ReadFormat20V0 reads a message at the format Format20V0
func ReadFormat20V0(data []byte) (*Format20V0, error) {
	...
	if formatTypeCode != adsb.Format20.GetTypeCode() {
		return nil, fmt.Errorf("the data are given at format %v and can not be read at the format Format20V0", formatTypeCode)
	}
