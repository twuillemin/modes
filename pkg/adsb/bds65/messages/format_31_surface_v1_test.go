...
func TestReadFormat31SurfaceV1(t *testing.T) {

	msg, err := ReadFormat31SurfaceV1(buildValidFormat31SurfaceV1Message())
	if err != nil {
		t.Fatal(err)
	}
	...
	if msg.GetSubtype() != fields.SubtypeSurface {
		t.Errorf("Expected Subtype \"%v\", got \"%v\"",
			fields.SubtypeSurface.ToString(),
...
func TestReadFormat31SurfaceV1TooShort(t *testing.T) {

	// Get too short data
	data := buildValidFormat31SurfaceV1Message()[:6]

	_, err := ReadFormat31SurfaceV1(data)
	if err == nil {
		t.Error(err)
	}
}

func TestReadFormat31SurfaceV1BadCode(t *testing.T) {

	// Change code to 2
	data := buildValidFormat31SurfaceV1Message()
...
func TestReadFormat31SurfaceV1BadSubType(t *testing.T) {
...
func TestReadFormat31SurfaceV1BadADSBLevel(t *testing.T) {
...
func TestReadFormat31SurfaceV1BadServiceLevel(t *testing.T) {
...
func TestReadFormat31SurfaceV1BadOMFormat(t *testing.T) {
...
func buildValidFormat31SurfaceV1Message() []byte {
	data := make([]byte, 7)
