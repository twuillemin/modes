...
const (
	...
	CRLowerThan3M ContainmentRadius = 5
	// CRBetween3MAnd10M denotes 3 m <= μ < 10 m
	CRBetween3MAnd10M ContainmentRadius = 6
	// CRBetween10MAnd92Point6M denotes 10 m <= μ < 92.6 m (0.05 NM)
	CRBetween10MAnd92Point6M ContainmentRadius = 7
	// CRGreaterThan92Point6M denotes 92.6 m (0.05 NM) <= μ
	CRGreaterThan92Point6M ContainmentRadius = 8
)
