...
func TestReadFormatDF18Valid(t *testing.T) {

	msg, err := ParseDF18(buildValidDF18Message())
	if err != nil {
		t.Fatal(err)
	}

	if msg.ControlField != fields.ControlFieldTISBRelayADSB {
		t.Errorf("Expected Capability \"%v\", got \"%v\"",
			fields.ControlFieldTISBRelayADSB.ToString(),
			msg.ControlField.ToString())
	}
...
func buildValidDF18Message() common.MessageData {
	...
	// 0000 0101: Unused (00000) + Control Field: TISBRelayADSB (101)
