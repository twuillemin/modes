...
// GetCPRSurfaceLocalPosition returns the exact position (based on two measure) of a plane position
//
// Params:
...
func GetCPRSurfaceLocalPosition(
	cprLatitude uint32,
	cprLongitude uint32,
	...
	dLon := 90.0 / (math.Max(getNumberOfLongitude(latitude)-i, 1.0))
