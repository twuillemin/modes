...
// GetCPRPositionWithReference returns the position (based on a single measure and a reference point) of a plane position
//
// Params:
...
func GetCPRPositionWithReference(
	cprLatitude uint32,
	cprLongitude uint32,
	...
	latCPR := float64(cprLatitude) / 131072.0
	lonCPR := float64(cprLongitude) / 131072.0
