...
func TestDetectAndReadReadFormat29Subtype0Valid(t *testing.T) {
	...
	msg, adsbResult, err := ReadBDS62(adsb.Level0OrMore, buildValidFormat29Subtype0Message())
	if err != nil {
		t.Fatal(err)
	}
...
func TestDetectAndReadReadFormat29Subtype1Valid(t *testing.T) {
	...
	msg, adsbResult, err := ReadBDS62(adsb.Level0OrMore, buildValidFormat29Subtype1Message())
	if err != nil {
		t.Fatal(err)
	}
...
func TestDetectBadFormat(t *testing.T) {
	...
	_, _, err := ReadBDS62(adsb.Level0OrMore, data)
	if err == nil {
