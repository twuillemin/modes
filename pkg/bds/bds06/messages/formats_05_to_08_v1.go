...
//
// This file was generated by gen_formats_v1.go at 2019-07-22 17:53:36.9318022 +0300 EEST m=+0.006981401
package messages
...
// readFormat05V1 reads a message at the format BDS 0,6
func readFormat05V1(nicSupplementA bool, data []byte) (*Format05V1, error) {

	formatTypeCode := (data[0] & 0xF8) >> 3

	if formatTypeCode != adsb.Format05V1.GetTypeCode() {
...
func (message *Format06V1) GetMessageFormat() adsb.MessageFormat {
	return adsb.Format06V1
}

// GetRegister returns the register of the message
func (message *Format06V1) GetRegister() bds.Register {
	return adsb.Format06V1.GetRegister()
}
...
// readFormat06V1 reads a message at the format BDS 0,6
func readFormat06V1(nicSupplementA bool, data []byte) (*Format06V1, error) {

	formatTypeCode := (data[0] & 0xF8) >> 3

	if formatTypeCode != adsb.Format06V1.GetTypeCode() {
...
// Format07V1 is a message at the format BDS 0,6
type Format07V1 struct {
	Movement                    fields.Movement
	GroundTrackStatus           fields.GroundTrackStatus
	GroundTrack                 fields.GroundTrack
	Time                        fields.Time
...
// GetMessageFormat returns the ADSB format of the message
func (message *Format07V1) GetMessageFormat() adsb.MessageFormat {
	return adsb.Format07V1
}

// GetRegister returns the register of the message
func (message *Format07V1) GetRegister() bds.Register {
	return adsb.Format07V1.GetRegister()
}

// GetMovement returns the Movement
func (message *Format07V1) GetMovement() fields.Movement {
	return message.Movement
}

// GetGroundTrackStatus returns the GroundTrackStatus
func (message *Format07V1) GetGroundTrackStatus() fields.GroundTrackStatus {
	return message.GroundTrackStatus
}

// GetGroundTrack returns the GroundTrack
func (message *Format07V1) GetGroundTrack() fields.GroundTrack {
	return message.GroundTrack
}

// GetTime returns the Time
func (message *Format07V1) GetTime() fields.Time {
	return message.Time
}

// GetCPRFormat returns the CompactPositionReportingFormat
func (message *Format07V1) GetCPRFormat() fields.CompactPositionReportingFormat {
	return message.CPRFormat
}

// GetEncodedLatitude returns the EncodedLatitude
func (message *Format07V1) GetEncodedLatitude() fields.EncodedLatitude {
	return message.EncodedLatitude
}

// GetEncodedLongitude returns the EncodedLongitude
func (message *Format07V1) GetEncodedLongitude() fields.EncodedLongitude {
	return message.EncodedLongitude
}

// GetHorizontalContainmentRadius returns the HorizontalContainmentRadiusV1
func (message *Format07V1) GetHorizontalContainmentRadius() fields.HorizontalContainmentRadiusV1 {
	return message.HorizontalContainmentRadius
}

// GetNavigationIntegrityCategory returns the Navigation Integrity Category
func (message *Format07V1) GetNavigationIntegrityCategory() byte {
	return message.NavigationIntegrityCategory
}

// ToString returns a basic, but readable, representation of the message
func (message *Format07V1) ToString() string {
	return messageBDS06V1ToString(message)
}

// readFormat07V1 reads a message at the format BDS 0,6
func readFormat07V1(nicSupplementA bool, data []byte) (*Format07V1, error) {

	formatTypeCode := (data[0] & 0xF8) >> 3

	if formatTypeCode != adsb.Format07V1.GetTypeCode() {
		return nil, fmt.Errorf("the data are given at format %v and can not be read at the format Format07V1", formatTypeCode)
	}
...
// readFormat08V1 reads a message at the format BDS 0,6
