...
//
// This file was generated by gen_formats_v2.go at 2024-06-01 14:32:27.3734841 +0300 EEST m=+0.001761501
package messages
...
func (message Format05V2) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format05V2) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format05V2) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}
...
// ReadFormat05V2 reads a message at the format Format05V2 for ADSB V2
