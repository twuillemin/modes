...
func TestReadFormat31SurfaceV2Valid(t *testing.T) {

	msg, err := ReadFormat31SurfaceV2(buildValidFormat31SurfaceV2Message())
	if err != nil {
		t.Fatal(err)
	}
...
func TestReadFormat31SurfaceV2TooShort(t *testing.T) {

	// Get too short data
	data := buildValidFormat31SurfaceV2Message()[:6]

	_, err := ReadFormat31SurfaceV2(data)
	if err == nil {
		t.Error(err)
	}
}

func TestReadFormat31SurfaceV2BadCode(t *testing.T) {
...
func TestReadFormat31SurfaceV2BadSubType(t *testing.T) {
...
func TestReadFormat31SurfaceV2BadADSBLevel(t *testing.T) {
...
func TestReadFormat31SurfaceV2BadContent(t *testing.T) {
...
func TestReadFormat31SurfaceV2BadOMFormat(t *testing.T) {
...
func buildValidFormat31SurfaceV2Message() []byte {
	data := make([]byte, 7)
