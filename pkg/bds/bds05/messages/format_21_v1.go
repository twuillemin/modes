...
//
// This file was generated by gen_formats_v1.go at 2024-06-01 12:49:13.6193965 +0300 EEST m=+0.006699301
package messages
...
func (message Format21V1) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format21V1) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel1
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format21V1) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel1
}
...
// ReadFormat21V1 reads a message at the format Format21V1
