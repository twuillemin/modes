...
//
// This file was generated by gen_formats_v2.go at 2019-08-15 19:22:01.8766668 +0300 EEST m=+0.010970501
package messages
...
func (message Format12V2) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format12V2) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format12V2) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}
...
// ReadFormat12V2 reads a message at the format Format12V2
