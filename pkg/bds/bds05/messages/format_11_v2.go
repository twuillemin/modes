...
//
// This file was generated by gen_formats_v2.go at 2024-06-01 12:49:14.2044714 +0300 EEST m=+0.003186301
package messages
...
func (message Format11V2) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format11V2) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format11V2) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}
...
// ReadFormat11V2 reads a message at the format Format11V2
