...
//
// This file was generated by gen_tests_v1.go at 2019-08-15 00:36:42.8578755 +0300 EEST m=+0.005994201
package messages
...
func TestReadFormat09V1Valid(t *testing.T) {
	...
	if msg.GetMessageFormat() != adsb.Format09V1 {
		t.Errorf("Expected Format \"%v\", got \"%v\"",
			adsb.Format09V1.ToString(),
