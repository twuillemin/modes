...
//
// This file was generated by gen_formats_v2.go at 2019-07-22 22:14:35.3369496 +0300 EEST m=+0.016967301
package messages
...
// readFormat20V2 reads a message at the format BDS 0,5
func readFormat20V2(data []byte) (*Format20V2, error) {

	formatTypeCode := (data[0] & 0xF8) >> 3

	if formatTypeCode != adsb.Format20V2.GetTypeCode() {
