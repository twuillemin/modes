...
//
// This file was generated by gen_formats_v2.go at 2019-08-15 19:22:01.8736749 +0300 EEST m=+0.007978601
package messages
...
// Format09V2 is a message at the format BDS 0,5 for ADSB V2
type Format09V2 struct {
...
func (message Format09V2) GetMessageFormat() adsb.MessageFormat {
	return adsb.Format09
}

// GetRegister returns the register of the message
func (message Format09V2) GetRegister() bds.Register {
	return adsb.Format09.GetRegister()
}

// GetSubtype returns the subtype of the message if any
func (message Format09V2) GetSubtype() adsb.Subtype {
	return nil
}

// GetMinimumADSBLevel returns the minimum ADSB Level for the message
func (message Format09V2) GetMinimumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}

// GetMaximumADSBLevel returns the maximum ADSB Level for the message
func (message Format09V2) GetMaximumADSBLevel() adsb.MessageLevel {
	return adsb.MessageLevel2
}

// GetSurveillanceStatus returns the Surveillance Status
func (message Format09V2) GetSurveillanceStatus() fields.SurveillanceStatus {
	return message.SurveillanceStatus
}

// GetNavigationIntegrityCodeSupplementB returns the NavigationIntegrityCodeSupplementB
func (message Format09V2) GetNavigationIntegrityCodeSupplementB() fields.NavigationIntegrityCodeSupplementB {
	return message.NavigationIntegrityCodeSupplementB
}

// GetAltitude returns the Altitude
func (message Format09V2) GetAltitude() fields.Altitude {
	return message.Altitude
}

// GetTime returns the Time
func (message Format09V2) GetTime() fields.Time {
	return message.Time
}

// GetCPRFormat returns the CompactPositionReportingFormat
func (message Format09V2) GetCPRFormat() fields.CompactPositionReportingFormat {
	return message.CPRFormat
}

// GetEncodedLatitude returns the EncodedLatitude
func (message Format09V2) GetEncodedLatitude() fields.EncodedLatitude {
	return message.EncodedLatitude
}

// GetEncodedLongitude returns the EncodedLongitude
func (message Format09V2) GetEncodedLongitude() fields.EncodedLongitude {
	return message.EncodedLongitude
}

// GetHorizontalContainmentRadius returns the HorizontalContainmentRadius
func (message Format09V2) GetHorizontalContainmentRadius() fields.HorizontalContainmentRadius {
	return message.HorizontalContainmentRadius
}

// GetNavigationIntegrityCategory returns the Navigation Integrity Category
func (message Format09V2) GetNavigationIntegrityCategory() byte {
	return message.NavigationIntegrityCategory
}

// ToString returns a basic, but readable, representation of the message
func (message Format09V2) ToString() string {
	return bds05v2ToString(message)
}

// ReadFormat09V2 reads a message at the format Format09V2
func ReadFormat09V2(nicSupplementA bool, data []byte) (*Format09V2, error) {
	...
	if formatTypeCode != adsb.Format09.GetTypeCode() {
		return nil, fmt.Errorf("the data are given at format %v and can not be read at the format Format09V2", formatTypeCode)
	}
